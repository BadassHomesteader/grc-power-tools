...
const SCENES = [
  ...
  ['08', `There's even an on-screen stream deck. Hold and tap B for the Macro Pad — one-tap buttons that file your Outlook mail, swap profiles with the app in front, and never steal focus. And hold and tap N for Quick Capture: type or dictate a line, and it posts straight to your own to-do app or webhook — priority, due date, and context parsed as you type.`],
  ['09', `Free, open source, signed and notarized. Download the D M G, drag it into Applications, grant two permissions — and hold Option Shift. Power Tools. One hotkey, a whole toolbox.`],
];
